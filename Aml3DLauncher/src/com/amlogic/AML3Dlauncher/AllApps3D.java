...
public class AllApps3D extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.getWindow().setBackgroundDrawableResource(R.drawable.appbg);
		TextView Title = (TextView)findViewById(R.id.apps_title);
		Title.setText(this.getResources().getString(R.string.app_title));
		Title.setGravity(0x00000010);
