...
//    };
    ...
    public void onCreate(Bundle savedInstanceState) {
            ...
            public void handleMessage(Message msg) {
				...
				case 12:    //update Searched list                                       
                    ...
                    if(lv_search_key == null)
						break;
                    lv.setAdapter(getSearchedFileListAdapterSorted(cur_path, lv_sort_flag,lv_search_key));                    
	   ...
	   boolean isEnableSearch = getResources().getBoolean(R.bool.has_enable_search);
	   if(!isEnableSearch)
	...
	*/
    ...
    protected Dialog onCreateDialog(int id) {
		...
		case SEARCH_DIALOG_ID:
	    	...
	    	search_dialog = new AlertDialog.Builder(FileBrower.this)   
	...
	private SimpleAdapter getSearchedFileListAdapterSorted(String path, String sort_type,String key ) {
    	if(path.equals(ROOT_PATH)) 
    	{
			return new SimpleAdapter(FileBrower.this,
        		getDeviceListData(),
        ...
        if (!mSearchedListLoaded) {
            ...
            new Thread("getSearchedFileListDataSortedAsync") {
                ...
                public void run() {                                       
					...
					Log.e(TAG,"----get list size is "+mList.size());
        	...
        	Log.e(TAG,"----return list size is "+mList.size());
            return mList;
        }             
