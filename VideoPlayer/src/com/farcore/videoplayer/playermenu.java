...
//        }
	...
	public void onWindowFocusChanged(boolean hasFocus) {   
		...
		if(hasFocus == true) {
			SystemProperties.set("vplayer.keyguard.enable","false");
		}
		else {
			SystemProperties.set("vplayer.keyguard.enable","true");
		}
    	...
    	public void handleMessage(Message msg) {
			...
			if(ignoreupdatetimecnt<=0){/*don't update the time if just update the seek.*/		
				...
				return;
						...
						seek_cur_time = 0;
						//if(!progressSliding)
						myProgressBar.setProgress((int)(currentf*100/totaltime));
					}
    				break;
