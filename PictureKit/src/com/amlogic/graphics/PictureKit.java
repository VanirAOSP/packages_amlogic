...
public class PictureKit
{
    ...
    private static native void freeBuffer(ByteBuffer buffer);
    /**
	...
	ImageInfo image = null;
    	try{
	    image = loadPictureNative(filename,info);
	    Bitmap bmp = Bitmap.createBitmap(image.outImageWidth, image.outImageHeight, Bitmap.Config.ARGB_8888);
	    bmp.copyPixelsFromBuffer(image.dataBuffer);
	    freeBuffer(image.dataBuffer);
	    return bmp;
    	}catch(OutOfMemoryError e){
	    System.out.println("loadPicture OutofMemoryError:" + e);
	    return null;
    	}catch(Exception e){
	    System.out.println("loadPicture error" + e);
	    return null;
	}
    }
    /**
