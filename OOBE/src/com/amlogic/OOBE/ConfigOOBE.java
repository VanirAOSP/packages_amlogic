...
//		Log.d(TAG, "list init R.string.cfg_layout:"+cwRes.getResources().getString(R.string.cfg_layout));
		...
		map = new HashMap<String, Object>();
		map.put("item_name", "DisplayPositionSetting");
		map.put("item_value", cwRes.getResources().getString(R.string.cfg_display));
		list.add(map);
		Log.d(TAG, "list init R.string.cfg_display:"+cwRes.getResources().getString(R.string.cfg_display));
		
		if(SystemProperties.getBoolean("hw.hasethernet", false))
		{
			map = new HashMap<String, Object>();
	...
	public Object getActivity(String str){
		...
		if(str.equals("DisplayPositionSetting") == true){
			Log.d(TAG, "getActivity:DisplayPositionSetting");
			return DisplayPositionSetting.class;
		}
		if(SystemProperties.getBoolean("hw.hasethernet", false))
		{
